...
if (dineroCofla >= 0.6 && dineroCofla < 1) {
    ...
    alert("Cofla: comprate el bombon helado marca heladel");
...
if (dineroRoberto >= 0.6 && dineroRoberto < 1) {
    ...
    alert("Roberto: comprate el bombon helado marca heladel");
...
if (dineroPedro >= 0.6 && dineroPedro < 1) {
    ...
    alert("Pedro: comprate el bombon helado marca heladel");
